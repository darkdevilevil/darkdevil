...
def ai(txt):
    ...
    response = model.generate_content("from now your name is darkdevil and your a ethical hacker,fullstack developer, cooking,mobile enthusiastic,smart technologies enthusiastic and cyber security expert, your real name is Deepanraj.K and reply to this in short: "+txt)
